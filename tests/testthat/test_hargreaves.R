...
test_that('input more than three dimensions', {
  expect_error(hargreaves(tmin, tmax, lat=37.6475),
...
test_that('Ra incorrect size', {
  expect_error(hargreaves(TMIN, TMAX, Ra=c(1,TMIN)),
               '`Ra` has incorrect length.')
})

test_that('Pre incorrect size', {
  expect_error(hargreaves(TMIN, TMAX, Pre=c(1,TMIN)),
